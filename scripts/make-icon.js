...
// ── 그리기 (256 기준 좌표) ──
const PINK = [233, 139, 170, 255];      // 헤더
const PINK_BORDER = [231, 201, 214, 255];
const CARD = [255, 253, 251, 255];      // 카드(거의 흰색, 살짝 핑크빛)
const LINE = [201, 191, 198, 255];      // 글줄(연회색)

fillRR(20, 24, 216, 208, 34, 34, PINK_BORDER); // 바깥 테두리(핑크)
fillRR(24, 28, 208, 200, 30, 30, CARD);        // 카드
fillRR(24, 28, 208, 54, 30, 0, PINK);          // 상단 핑크 헤더(위만 둥글게)
// 본문 글줄 3개(마지막은 짧게)
